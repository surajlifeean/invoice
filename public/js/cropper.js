...
class Cropper {
  ...
  export(img) {
    ...
    var img=this.previewCanvas.toDataURL();

    document.getElementById('company_name_2').value=cname.value;
    document.getElementById('email_id_2').value=eid.value;
    document.getElementById('contact_no_2').value=cno.value;
    document.getElementById('address_2').value=add.value;
...
var dimensions = { width: 200, height: 128 };
